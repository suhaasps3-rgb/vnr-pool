      ...
      <JourneyProvider>
        ...
        <div className="sticky top-0 w-full h-screen overflow-hidden">
          <div className="w-full h-full max-w-7xl mx-auto grid grid-cols-1 grid-rows-[auto_1fr] md:grid-cols-2 md:grid-rows-1 px-4 sm:px-6 relative">
            ...
            <div className="w-full h-full min-h-[300px] relative z-20 flex items-start md:items-center justify-center lg:-ml-12 xl:-ml-24 pointer-events-none overflow-hidden -mt-32 md:mt-0">
              <AmbientLife />
              <ProductDemoHUD />
              <RouteScene />
            </div>
